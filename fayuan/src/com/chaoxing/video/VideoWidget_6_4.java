...
public class VideoWidget_6_4 extends AppWidgetProvider {
	private final static String TAG = "VideoWidget_6_4";
	...
	public void onUpdate(Context context, 
		...
		for (int i=0; i<N; i++) {
			...
			RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.video_widget_6_4);
