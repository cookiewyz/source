...
import com.chaoxing.document.OtherInfo;
import com.chaoxing.document.VideoPathInfo;
...
public class SSVideoPlayListBean implements Serializable  {
	...
	List<VideoPathInfo> list = new ArrayList<VideoPathInfo>();

	public List<VideoPathInfo> getList() {
		return list;
	}

	public void setList(List<VideoPathInfo> list) {
		this.list = list;
	}
	...
	public String toString() {
	   String str = this.strVideoName+"   "+this.strVideoId;
		return str;
	}
