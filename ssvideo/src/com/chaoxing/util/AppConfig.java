...
public class AppConfig {
	...
	public static final String packageName = "com.chaoxing.video";//定制需修改.
	
	//文件夹
	public static final String userRootDir = "ssvideo";//定制需修改.
	public static final String logo = "logo";
	public static final String commendVideo = "commendVideos";
	
	//raw资源文件
	public static final String userDbName = "ssvideo.db";//定制需修改.
